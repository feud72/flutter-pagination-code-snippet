...
abstract class $OwnerCopyWith<$Res> {
  ...
  $Res call({int id, String? nickname, String username});
}
...
class _$_Owner implements _Owner {
  const _$_Owner(
      {required this.id, required this.nickname, required this.username});
  ...
  @override
  String toString() {
    return 'Owner(id: $id, nickname: $nickname, username: $username)';
  }
...
abstract class _Owner implements Owner {
  const factory _Owner(
      ...
      required final String username}) = _$_Owner;
